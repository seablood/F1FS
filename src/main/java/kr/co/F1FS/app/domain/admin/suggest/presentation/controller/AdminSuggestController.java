...
import kr.co.F1FS.app.domain.admin.suggest.application.service.AdminSuggestService;
...
public class AdminSuggestController {
    private final AdminSuggestService adminSuggestService;
    ...
    public ResponseEntity<List<ResponseSuggestDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        Page<ResponseSuggestDTO> newPage = adminSuggestService.findAll(page, size);
    ...
    public ResponseEntity<Void> confirmedToggle(@PathVariable Long id){
        adminSuggestService.suggestConfirmedToggle(id);
