...
import kr.co.F1FS.app.domain.admin.user.application.service.AdminUserService;
...
public class AdminUserController {
    ...
    public ResponseEntity<List<AdminResponseUserComplainDTO>> findAllForComplain(
        ...
        Page<AdminResponseUserComplainDTO> newPage = adminUserService.findAll(page, size, condition);
    ...
    public ResponseEntity<List<AdminResponseUserComplainDTO>> findComplainByUser(
        ...
        Page<AdminResponseUserComplainDTO> newPage = adminUserService.getComplainByUser(page, size, condition, search);
        return ResponseEntity.status(HttpStatus.OK).body(newPage.getContent());
    }
