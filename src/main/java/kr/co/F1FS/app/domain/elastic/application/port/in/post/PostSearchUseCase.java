...
public interface PostSearchUseCase {
    Page<ResponsePostDocumentDTO> getPostList(int page, int size, String condition, String option, String keyword, Long roomId);
    Page<ResponsePostDocumentDTO> getPostListByTags(int page, int size, String condition, TagListRequestDTO dto, Long roomId);
}
