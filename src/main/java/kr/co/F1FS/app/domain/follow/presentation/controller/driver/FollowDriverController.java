package kr.co.F1FS.app.domain.follow.presentation.controller.driver;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import kr.co.F1FS.app.domain.follow.application.port.in.driver.FollowDriverUseCase;
...
public class FollowDriverController {
    private final FollowDriverUseCase followDriverUseCase;
    ...
    public ResponseEntity<Void> toggle(@PathVariable Long driverId, @AuthenticationPrincipal PrincipalDetails details){
        followDriverUseCase.toggle(details.getUser(), driverId);
