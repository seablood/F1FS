package kr.co.F1FS.app.domain.elastic.presentation.controller.chatRoom;
...
@Tag(name = "채팅방 실시간 검색", description = "채팅방을 실시간으로 검색")
public class ChatRoomSearchController {
    ...
    public ResponseEntity<List<ResponseChatRoomDocumentDTO>> pageSearch(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(chatRoomSearchUseCase.getChatRoomList(
