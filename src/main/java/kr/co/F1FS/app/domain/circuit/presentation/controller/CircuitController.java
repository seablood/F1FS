...
import kr.co.F1FS.app.domain.circuit.application.service.CircuitService;
...
public class CircuitController {
    ...
    public ResponseEntity<List<SimpleResponseCircuitDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        Page<SimpleResponseCircuitDTO> newPage = circuitService.findAll(page, size);
    ...
    public ResponseEntity<ResponseCircuitDTO> getCircuitById(@PathVariable Long id){
        return ResponseEntity.status(HttpStatus.OK).body(circuitService.getCircuitById(id));
    }
}
