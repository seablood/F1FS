...
@Tag(name = "컨스트럭터 컨트롤러", description = "컨스트럭터 관련 서비스")
public class ConstructorController {
    ...
    public ResponseEntity<ResponseConstructorDTO> findById(@PathVariable Long id){
        return ResponseEntity.status(HttpStatus.OK).body(constructorUseCase.getConstructorById(id));
    }
    ...
    public ResponseEntity<List<SimpleResponseConstructorDTO>> getConstructorAll(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        Page<SimpleResponseConstructorDTO> newPage = constructorUseCase.getConstructorAll(page, size, condition);
