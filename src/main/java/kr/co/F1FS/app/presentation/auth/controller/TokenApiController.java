package kr.co.F1FS.app.presentation.auth.controller;
...
import kr.co.F1FS.app.application.auth.TokenService;
...
public class TokenApiController {
    ...
    public ResponseEntity<Void> createNewToken(HttpServletRequest request, HttpServletResponse response,
        ...
        tokenService.createNewAccessToken(principalDetails.getUser().getId(), refreshToken, response);
